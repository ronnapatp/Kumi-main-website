  ...
  <div className="container">
    <header className="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      ...
      <ul className="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
        ...
        <li><Link href="/"><a className="nav-link px-2 link-dark">Products</a></Link></li>
        <li><Link href="/"><a className="nav-link px-2 link-dark">About</a></Link></li>
        <li><Link href="/"><a className="nav-link px-2 link-dark">Blog</a></Link></li>
        <li><Link href="/"><a className="nav-link px-2 link-dark">Contact</a></Link></li>
      </ul>
